                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input  minlength="3" maxlength="15" type="text"  class="form-control" id="txtNombre" name="txtNombre"  required="" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input  minlength="10" maxlength="100" type="text"  class="form-control" id="txtDireccion" name="txtDireccion"  value="" required="" >
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
